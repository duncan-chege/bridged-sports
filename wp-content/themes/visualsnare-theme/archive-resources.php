...
<div class="home splide" role="group" aria-label="Homepage Splide">
    <div class="splide__track">
        ...
        <li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/night-event.png"
                    alt="" /></li>
            <li class="splide__slide"><img
                    src="<?php echo get_template_directory_uri(); ?>/assets/img/nike-shoot.png" alt="" /></li>
        </ul>
    </div>
